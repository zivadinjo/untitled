...
public class SmsParts {
    public static void main(String[] args) {
        ...
        int mesageStarts = msg.indexOf("{");
        int mesageEnds = msg.indexOf("}");

        System.out.println("Sender: " + msg.substring(senderStart + 1, senderEnd));
        System.out.println("Phone number: " + msg.substring(numberStart + 1, numberEnd));
        System.out.println("Message: "+ msg.substring(mesageStarts + 1 , mesageEnds));
