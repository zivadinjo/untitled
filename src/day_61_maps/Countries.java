...
public class Countries {
    public static void main(String[] args) {
        ...
        Map<String, ArrayList<String>> countries = new HashMap<>(); // created a HashMap that has key of String type - countries and ArrayList<String> for the value and those will be cities
        ...
        for (ArrayList<String> cities : countries.values()){ // iterates through the values of the map,which is ArrayList of cities
        ...
        System.out.println("What country you want the tour?");
